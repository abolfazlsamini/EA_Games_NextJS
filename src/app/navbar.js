...
export default function Navbar() {
  ...
  return (
    <div className="fixed top-0 z-10 min-h-16 w-full">
      <div className="flex min-h-16 items-center justify-start bg-black px-4 py-1">
        ...
        <a className="absolute right-5 m-auto md:hidden">
          <div className="relative m-2 w-full rounded-3xl bg-[#F04] p-5 py-3 text-center font-druk_text_medium sm:max-w-36 sm:text-lg md:block [&_*]:hover:max-h-52">
            <div className="text-xs">
              ...
              <div className="absolute right-1 m-auto max-h-0 w-32 overflow-hidden bg-black px-2 text-white transition-all duration-500">
                <button className="btn mt-2 w-full rounded-3xl border-2 bg-transparent p-5 py-3 font-druk_text_medium hover:scale-[102%] sm:max-w-36 sm:text-lg md:hover:scale-105">
                  <div className="btn_div">BUY NOW</div>
                </button>
                <button className="btn my-2 w-full rounded-3xl border-2 bg-transparent p-5 py-3 font-druk_text_medium hover:scale-[102%] sm:max-w-36 sm:text-lg md:hover:scale-105">
                  <div className="btn_div">BUY NOW</div>
                </button>
              </div>
            </div>
      ...
      >
        ...
        ></div>
        <nav
          className={`fixed bottom-0 left-0 top-0 ${toggle} flex w-5/6 max-w-sm flex-col overflow-y-auto border-r bg-black px-6 py-6 duration-500`}
        >
